...
In alpha: `pip install adminsite==0.1.0a4`. Documentation: https://nimaxin.github.io/adminsite/
...
- **Translations**, with Persian built in and a mirrored layout for right to left languages.
- **A JSON API** over the same views and permissions, with bearer tokens for scripts.
